...
# did 120k and about to try for 180k
sample_size = 120000
...
# Access final loss from trainer.state
final_train_loss = trainer.state.log_history[-2].get("loss", "N/A")  # Second last log should be final train loss
final_val_loss = trainer.state.log_history[-1].get("eval_loss", "N/A")  # Last log is final val loss
...
run_data = {
    ...
    "Training Loss (Final)": final_train_loss,
    "Validation Loss (Final)": final_val_loss,
...
print(f"✅ Logged Run 3 to {eval_log_path}")